...
const members = [
	{
		...
		img: "http://mindfulseeds.torontosharehouse.com/wp/wp-content/uploads/2024/02/don.jpg",
	},
	{
		category: "Team Members",
		name: "Grace Garcia",
		...
		img: "http://mindfulseeds.torontosharehouse.com/wp/wp-content/uploads/2024/02/grace.jpg",
	},
	{
		category: "Team Members",
		name: "Harvey Quan",
		...
		img: "http://mindfulseeds.torontosharehouse.com/wp/wp-content/uploads/2024/02/harvey.jpg",
	},
];
						...
						<div class="mx-auto max-w-screen-xl px-4 md:px-8">
							<div class="grid gap-8 md:grid-cols-6 lg:gap-12">
								<div className="md:col-span-2">
									<div class="mb-4 md:mb-6 h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
										<img
											src={item.img}
											loading="lazy"
											alt={item.name}
									...
									<h1 class="text-center text-2xl font-bold text-gray-800 sm:text-3xl md:text-left">
										{item.name}
									</h1>
									<p class="text-center font-bold text-primary-500 md:text-left">
										{item.occupation}
									</p>
								</div>
